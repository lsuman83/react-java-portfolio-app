                    ...
                    <div class="w-full py-6 z-20">
                        ...
                        <form action="" class="sm:w-2/3 w-full px-4 lg:px-0 mx-auto">
                            ...
                            <div class="text-gray-400">
                                <p class='sm:inline-block sm:pr-8'>New here?<NavLink class='pl-2 hover:underline hover:text-gray-100' exact to='/signup'>Sign up</NavLink></p>
                                <a class='sm:inline-block sm:pl-8 hover:underline hover:text-gray-100' href="#">Forgot your password?</a>
                            </div>
