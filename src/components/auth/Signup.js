    ...
    render() {
        return (
            <section class="min-h-screen flex items-stretch text-white ">
                <div class="lg:flex w-1/2 hidden bg-gray-500 bg-no-repeat bg-cover relative items-center" style={{backgroundImage: 'url('+tattooPic+')'}}>
                ...
                <div class="lg:w-1/2 w-full flex items-center justify-center text-center md:px-16 px-0 z-0" style={{backgroundColor: '#161616'}}>
                    ...
                    <div class="w-full py-6 z-20">
                        ...
                        <form action="" class="sm:w-2/3 w-full px-4 lg:px-0 mx-auto">
                            <div class="pb-2 pt-4">
                                <input type="text" name="first_name" id="first_name" placeholder="First Name" class="block w-full p-4 text-lg rounded-sm bg-black" />
                            </div>
                            <div class="pb-2 pt-4">
                                <input type="text" name="last_name" id="last_name" placeholder="Last Name" class="block w-full p-4 text-lg rounded-sm bg-black" />
                            </div>
                            <div class="pb-2 pt-4">
                            ...
                            <div class="text-right text-gray-400">
                                <p>Have an account?<NavLink class='pl-2 hover:underline hover:text-gray-100' exact to='/login'>Log in</NavLink></p>
                            </div>
